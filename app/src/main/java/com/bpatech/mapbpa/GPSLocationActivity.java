...
public class GPSLocationActivity extends FragmentActivity implements ConnectionCallbacks,
    ...
    ArrayList<LatLng> location_lats = new ArrayList<LatLng>();
    ...
    private void displayLocation() {
        ...
        if (mLastLocation != null) {
            ...
            location_lats.add(new LatLng(latitude,longitude));
